package com.gome.idea.plugins.time.layout
...
class VerticalLayout extends FlowLayout {
     ...
     */
    public VerticalLayout(boolean hfill, boolean vfill) {
     ...
     *            the vertical fill in pixels. 
     */
    public VerticalLayout(int align, boolean hfill, boolean vfill) {
     ...
     */
    public VerticalLayout(int align, int hgap, int vgap, boolean hfill, boolean vfill) {
        setAlignment(align)
        this.hgap = hgap
        this.vgap = vgap
        this.hfill = hfill
